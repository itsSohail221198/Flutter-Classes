...
class AndroidUiautomator2Driver extends appium_android_driver_1.default {
    ...
    async initAUT() {
        ...
        if (this.opts.uninstallOtherPackages) {
            await helpers.uninstallOtherPackages(this.adb, helpers.parseArray(this.opts.uninstallOtherPackages), [io_appium_settings_1.SETTINGS_HELPER_ID, uiautomator2_1.SERVER_PACKAGE_ID, uiautomator2_1.SERVER_TEST_PACKAGE_ID]);
        }
