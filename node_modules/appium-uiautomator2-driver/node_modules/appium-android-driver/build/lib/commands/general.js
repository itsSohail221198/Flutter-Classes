...
const GeneralMixin = {
    ...
    async getStrings(language) {
        ...
        this.apkStrings[language] = await android_1.default.pushStrings(language, this.adb, this.opts);
        return preprocessStringsMap(this.apkStrings[language]);
    },
    async launchApp() {
        throw new driver_1.errors.NotImplementedError('Not implemented');
    ...
    async reset() {
        await android_1.default.resetApp(this.adb, Object.assign({}, this.opts, { fastReset: true }));
    ...
    async mobileUnlock(opts = {}) {
        ...
        if (!key && !type) {
            ...
            await android_1.default.unlock(this, this.adb, {
                unlockKey: key,
                unlockType: type,
